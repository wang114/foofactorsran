...
If `droplevel = FALSE`, the levels for x will be `c("Children","Youth","Adult","Senior")`. If `droplevel = TRUE`, which is also the default setting, the unused levels of age groups will be dropped, but the order of levels stay as the same. 
